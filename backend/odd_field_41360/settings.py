"""
Django settings for odd_field_41360 project.
...
ROOT_URLCONF = 'odd_field_41360.urls'
...
WSGI_APPLICATION = 'odd_field_41360.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_field_41360 API",
    "DESCRIPTION": "API documentation for odd_field_41360 App",
    "VERSION": "v1",
}
